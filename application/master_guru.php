    ...
    <div class="box">
      ...
      <div class="box-body">
        <table id="example1" class="table table-bordered table-striped">
          ...
          <tbody>
            <?php
            $tampil = mysqli_query($koneksi2, "SELECT * FROM tbl_peg");
            $no = 1;
...
<?php echo "</a> <span style='width:155px' class='label label-info' id='upload-file-info'></span>
  ...
  $detail = mysqli_query($koneksi2, "SELECT * FROM tbl_peg a where a.nik='$_GET[id]'");
  $s = mysqli_fetch_array($detail);
  echo "<div class='col-md-12'>
              <div class='box box-info'>
                <div class='box-header with-border'>
  ...
  if (trim($s[pasfoto]) == '') {
    ...
    echo "<img class='img-thumbnail' style='width:155px' src='http://musase.smpmuh1seyegan.sch.id/assets/uploads/$s[pasfoto]'>";
  }

  echo "</th>
                    </tr>
                    <tr><th width='120px' scope='row'>Nip</th>      <td>$s[nip]</td></tr>
                    <tr><th scope='row'>Password</th>               <td>$s[pass]</td></tr>
                    <tr><th scope='row'>Nama Lengkap</th>           <td>$s[nama]</td></tr>
                    <tr><th scope='row'>Tempat Lahir</th>           <td>$s[t4_lhr]</td></tr>
                    <tr><th scope='row'>Tanggal Lahir</th>          <td>$s[tgl_lahir]</td></tr>
                    <tr><th scope='row'>Jenis Kelamin</th>          <td>$s[sex]</td></tr>
                ...
                <div class='col-md-5'>
                  ...
                  <tbody>
                    ...
                    <tr><th scope='row'>Keahlian Breile</th>            <td>$s[keahlian_braille]</td></tr>
                    ...
                    <tr><th scope='row'>NBM</th>            <td>$s[nbm]</td></tr>
